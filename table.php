                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive m-b-40">
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM orderlist WHERE CONCAT(customer_name,payment_status,platefromName) LIKE '%$filtervalues%' ";
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $items["order_details"]?></td>
                                                    <td><?= $items["final_amount"]?></td>
                                                    <td><?= $items["payment_status"]?></td>
                                                    <td><?= $items["platefromName"]?></td>
                                                </tr>
                                                <?php
                                            }
                                        }
